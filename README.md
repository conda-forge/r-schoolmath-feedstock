...
pixi add r-schoolmath
# for installing globally
pixi global install r-schoolmath
```
...
It is possible to list all of the versions of `r-schoolmath` available on your platform:
...
```
pixi search r-schoolmath --channel conda-forge
```
